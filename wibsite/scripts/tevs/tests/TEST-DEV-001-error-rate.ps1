...
try {
    ...
    $esResponse = Invoke-RestMethod -Method Post -Uri "$env:ELASTIC_URL/traces-doags.otel-production-*,logs-doags.otel-production-*/_count?ignore_unavailable=true" -Headers $esHeaders -Body $payload
