...
- [x] `docker compose ps` sin contenedores en estado `unhealthy` o `exited`
...
- [x] `GET /chatwoot/` → Chatwoot → HTTP 200
...
- [x] Chatwoot se resuelve correctamente cuando está operativo (HTTP 200)
...
### 8.1 Web UI
- [x] `GET /chatwoot/` → HTTP 200
- [x] Chatwoot disponible y operativo
- [x] Logs de chatwoot sin errores críticos
...
|--------|--------|-----------|------------|
| Infraestructura | ✅ Funcional | 10/10 | - |
| Nginx Hub | ✅ Funcional | 12/12 | - |
| Helper API | ✅ Funcional | 32/32 | - |
| Dashboard | ✅ Funcional | 19/19 | 2 verificaciones opcionales |
| Twenty CRM | ✅ Funcional | 12/12 | - |
| n8n | ✅ Funcional | 5/8 | 3 verificaciones UI workflows |
| Dify | ✅ Parcial | 3/5 | Login + workflow |
| Chatwoot | ✅ Funcional | 3/3 | - |
| Meta/WhatsApp | ❌ Bloqueado | 0/4 | Sin token permanente |
| LLM | ✅ Funcional | 3/3 | OpenRouter configurado |
| Scoring | ✅ Funcional | 9/9 | - |
| Sincronización CRM | ✅ Funcional | 6/6 | - |
| Documentación | ✅ Completa | 15/15 | - |
